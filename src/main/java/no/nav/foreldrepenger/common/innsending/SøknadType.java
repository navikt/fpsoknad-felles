...
import static no.nav.foreldrepenger.common.util.CounterRegistry.ES_ETTERSENDING;
import static no.nav.foreldrepenger.common.util.CounterRegistry.ES_FØRSTEGANG;
import static no.nav.foreldrepenger.common.util.CounterRegistry.FP_ENDRING;
import static no.nav.foreldrepenger.common.util.CounterRegistry.FP_ETTERSENDING;
import static no.nav.foreldrepenger.common.util.CounterRegistry.FP_FØRSTEGANG;
import static no.nav.foreldrepenger.common.util.CounterRegistry.SVP_ETTERSENDING;
import static no.nav.foreldrepenger.common.util.CounterRegistry.SVP_FØRSTEGANG;
