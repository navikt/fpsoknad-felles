...
import no.nav.foreldrepenger.common.innsyn.vedtak.SaksInformasjon;
import no.nav.foreldrepenger.common.innsyn.vedtak.Vedtak;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.ArbeidType;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.AvslagsÅrsak;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.ManuellBehandlingsÅrsak;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.PeriodeAktivitet;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.UttaksPeriode;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.UttaksPeriodeResultatType;
import no.nav.foreldrepenger.common.innsyn.vedtak.uttak.UttaksPeriodeResultatÅrsak;
import no.nav.foreldrepenger.common.util.jaxb.VedtakV2ESJAXBUtil;
import no.nav.foreldrepenger.common.util.jaxb.VedtakV2FPJAXBUtil;
...
public class V2XMLVedtakMapper implements XMLVedtakMapper {
    ...
    private static no.nav.foreldrepenger.common.innsyn.vedtak.uttak.Uttak tilUttak(UttakForeldrepenger uttak) {
        return new no.nav.foreldrepenger.common.innsyn.vedtak.uttak.Uttak(
