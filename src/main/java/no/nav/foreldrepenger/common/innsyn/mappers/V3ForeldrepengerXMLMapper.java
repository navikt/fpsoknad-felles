...
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.tilLand;
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.tilMedlemsskap;
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.tilOpptjening;
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.tilSøker;
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.tilVedlegg;
import static no.nav.foreldrepenger.common.innsyn.mappers.V3XMLMapperCommon.ytelse;
